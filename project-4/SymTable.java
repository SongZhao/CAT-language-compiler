...
public class SymTable {
    ...
    public SymTable(HashMap<String, SemSym> subTable)
    {
	list = new LinkedList<HashMap<String, SemSym>>();
	list.add(new HashMap<String, SemSym>(subTable));
   }
    public SymTable() {
        list = new LinkedList<HashMap<String, SemSym>>();
    ...
    public HashMap<String, SemSym> getFirstSubTable()
    {
	return list.get(0);
	}
    ...
    public void addnewScope(SymTable subTable)
	{
		list.add(0, subTable.getFirstSubTable());
